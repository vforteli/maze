...
describe("getNeighbours", () => {
  test("top left", () => {
    expect(getNeighbours({ x: 0, y: 0 }, 3, 3)).toEqual([
      { direction: 90, x: 1, y: 0 },
      { direction: 180, x: 0, y: 1 },
    ]);
  });

  test("top middle", () => {
    expect(getNeighbours({ x: 1, y: 0 }, 3, 3)).toEqual([
      { direction: 90, x: 2, y: 0 },
      { direction: 180, x: 1, y: 1 },
      { direction: 270, x: 0, y: 0 },
    ]);
  });

  test("top right", () => {
    expect(getNeighbours({ x: 2, y: 0 }, 3, 3)).toEqual([
      { direction: 180, x: 2, y: 1 },
      { direction: 270, x: 1, y: 0 },
    ]);
  });
  ...
  test("middle", () => {
    expect(getNeighbours({ x: 1, y: 1 }, 3, 3)).toEqual([
      { direction: 0, x: 1, y: 0 },
      { direction: 90, x: 2, y: 1 },
      { direction: 180, x: 1, y: 2 },
      { direction: 270, x: 0, y: 1 },
    ]);
  });
  ...
  test("bottom middle", () => {
    expect(getNeighbours({ x: 1, y: 2 }, 3, 3)).toEqual([
      { direction: 0, x: 1, y: 1 },
      { direction: 90, x: 2, y: 2 },
      { direction: 270, x: 0, y: 2 },
    ]);
  });
  ...
  test("left middle", () => {
    expect(getNeighbours({ x: 0, y: 1 }, 3, 3)).toEqual([
      { direction: 0, x: 0, y: 0 },
      { direction: 90, x: 1, y: 1 },
      { direction: 180, x: 0, y: 2 },
    ]);
  });
  ...
  test("right middle", () => {
    expect(getNeighbours({ x: 2, y: 1 }, 3, 3)).toEqual([
      { direction: 0, x: 2, y: 0 },
      { direction: 180, x: 2, y: 2 },
      { direction: 270, x: 1, y: 1 },
    ]);
  });
});
